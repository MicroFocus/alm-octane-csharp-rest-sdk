...
namespace MicroFocus.Adm.Octane.Api.Core.Entities.Tests
{
    public class TestSuiteLinkToTest : BaseEntity
    {
        public static string SUBTYPE_FIELD = "subtype";

        public TestSuiteLinkToTest()
        {
            AggregateType = "test_suite_link_to_test";
        }

        public TestSuiteLinkToTest(EntityId id)
            : base(id)
        {
            AggregateType = "test_suite_link_to_test";
        }
